// Use require to avoid TypeScript export mismatches in this environment
...
async function main() {
  ...
  const adminUser = await prisma.adminUser.upsert({
    where: { email: process.env.ADMIN_EMAIL ?? "sayan@learnsapwithsayan.com" },
    update: {},
    create: {
      email: process.env.ADMIN_EMAIL ?? "sayan@learnsapwithsayan.com",
      name: "Sayan",
